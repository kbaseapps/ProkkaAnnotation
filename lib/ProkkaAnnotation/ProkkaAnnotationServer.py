...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'ProkkaAnnotation'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from ProkkaAnnotation.ProkkaAnnotationImpl import ProkkaAnnotation  # noqa @IgnorePep8
impl_ProkkaAnnotation = ProkkaAnnotation(config)
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'ProkkaAnnotation'
