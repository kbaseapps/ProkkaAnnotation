...
/**
 * <p>Original spec-file module name: ProkkaAnnotation</p>
 * <pre>
 * A KBase module: ProkkaAnnotation
 * </pre>
 */
public class ProkkaAnnotationClient {
     ...
     */
    public ProkkaAnnotationClient(URL url) {
     ...
     * validity.
     */
    public ProkkaAnnotationClient(URL url, AuthToken token) throws UnauthorizedException, IOException {
     ...
     * credentials.
     */
    public ProkkaAnnotationClient(URL url, String user, String password) throws UnauthorizedException, IOException {
     ...
     * credentials.
     */
    public ProkkaAnnotationClient(URL url, String user, String password, URL auth) throws UnauthorizedException, IOException {
    ...
    public Map<String, Object> status(RpcContext... jsonRpcContext) throws IOException, JsonClientException {
        ...
        List<Map<String, Object>> res = caller.jsonrpcCall("ProkkaAnnotation.status", args, retType, true, false, jsonRpcContext, this.serviceVersion);
        return res.get(0);
    }
}
